...
<div class="FormField">
    ...
    <table>
        ...
        <tr>
            <td class="field-options">Orientation</td>
            <td colspan="3"><%: Html.RadioButtonFor(formfield => formfield.Orientation, "vertical") %>Vertical <%: Html.RadioButtonFor(formfield => formfield.Orientation, "horizontal") %>Horizontal</td>
        </tr>
    </table>
    <% } %>
</div>
